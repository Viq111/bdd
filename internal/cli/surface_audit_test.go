...
var cardFieldAudit = map[string]string{
	...
	"Status":       "mutable: UpdateCard.Status plus the claim/close/reopen/release/defer/human lifecycle methods",
	...
	"Assignee":     "mutable, but only through the claim/reopen/release lifecycle methods, not a free-form UpdateCard field",
	...
	"StartedAt":    "read-only field, but reachable indirectly: set by ClaimCard, cleared by ReopenCard/ReleaseCard",
