...
var schemaV1 = map[string][]columnSpec{
	...
	"cards":              {{"id", "TEXT", 0, 1}, {"title", "TEXT", 1, 0}, {"worktree", "TEXT", 1, 0}, {"description", "TEXT", 1, 0}, {"reproduction", "TEXT", 1, 0}, {"design", "TEXT", 1, 0}, {"acceptance", "TEXT", 1, 0}, {"status", "TEXT", 1, 0}, {"priority", "INTEGER", 1, 0}, {"card_type", "TEXT", 1, 0}, {"external_ref", "TEXT", 1, 0}, {"assignee", "TEXT", 1, 0}, {"created_by", "TEXT", 1, 0}, {"created_at", "TEXT", 1, 0}, {"updated_at", "TEXT", 1, 0}, {"started_at", "TEXT", 0, 0}, {"closed_at", "TEXT", 0, 0}, {"defer_until", "TEXT", 0, 0}, {"revision", "INTEGER", 1, 0}, {"owner", "TEXT", 1, 0}},
